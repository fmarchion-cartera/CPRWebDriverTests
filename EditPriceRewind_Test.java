 ...
 */
public class EditPriceRewind_Test {
...

    {
        ...
        //Click the X in the All Set modal
        StartPriceRewind.click_All_Set_Close();
        try {
            Thread.sleep(2000);
        } catch (Exception e) {
            e.printStackTrace();
        ...
        //Click the 'Edit Purchase Detail' link
        StartPriceRewind.click_Edit_PriceRewind();

        //Enter a new 'Purchase Price'
        StartPriceRewind.setText_PurchasePrice("505.72");

        //Enter a new date
        StartPriceRewind.setText_Date_Field("8/10/17");

        //Enter a new store name
        StartPriceRewind.enter_Store_Name("Amazon");

        //Select a new payment method 'credit'
        StartPriceRewind.select_Payment_type2();
