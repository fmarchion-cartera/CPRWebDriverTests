...
import com.citipricerewind.pages.SaveDraft;
...
public class SaveDraft_Test {
    ...
    public void setup(){
        ...
        SaveDraft = PageFactory.initElements(driver, SaveDraft.class);
    }
...

    {
        ...
        SaveDraft.click_Save_Button();
        try {
            Thread.sleep(1000);
        } catch (Exception e) {
            e.printStackTrace();
        }
        String trackSaved = driver.findElement(By.cssSelector(".cpr_modalTitle.cpr_focusable")).getText();
        assertTrue(trackSaved.contains("DRAFT CREATED"));
